...
class InsureeMasterPanel extends FormPanel {
  ...
  render() {
    ...
    const EditedEnrolmentType = edited && edited?.family?.jsonExt && JSON.parse(edited?.family?.jsonExt);
    return (
      <Grid container>
        <Grid item xs={12}>
            ...
            <Grid container className={classes.item}>
              ...
              <Grid item xs={4} className={classes.item}>
                <TextInput
                  ...
                  onChange={(v) => {
                    this.updateAttribute("lastName", v.toUpperCase());
                  }}
                />
              </Grid>
              <Grid item xs={4} className={classes.item}>
          ...
          {!!edited && !!edited?.chfId ? (
            <PolicySummary modulesManager={this.props.modulesManager} edited_id={edited_id} />
          ) : null}
          {/* <Contributions
            edited={edited}
            {...this.props}
